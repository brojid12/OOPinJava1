This is my 1st project using JAVA language, hope this syntax sent clearly and if you want to ask question 

This code is for showing the workflow of OOP (Inheritance, Polymorphism, Encapsulation, etc.) using smartphone features 
which is ACCESSING CONTACT and PLAYING MUSIC
